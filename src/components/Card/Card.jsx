const Card = ({ imgUrl, text, color, imgRadius, quotes }) => {
  ...
  return (
    <figure
      className={`rounded-3xl p-8 border-solid border-4 font-nunito text-${color}-900 border-${color}-900 bg-${color}-200 dark:border-[#5090D3] dark:bg-[#001E3C]`}
    >
      <img
      ...
      <div className="pt-6 text-center space-y-4">
        <blockquote>
          <p className="text-lg font-light antialiased dark:text-white">
            {quotes ? (
              <>
